...
- RDS: **PostgreSQL 18.3 / db.t3.micro Single-AZ** + automated backup 7일 (2026-05-09 4차 PIVOT — 학생 SCP가 RDS 엔진 16/17 노출 안 해 18.3-R1만 가용). Flyway 10 + PG 18.3 호환성은 첫 배포 시 실행 로그로 검증 (deferred-work 첫 항목 참조). 학생 계정 SCP가 db.t4g.micro arm64 미가용
